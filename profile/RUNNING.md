...
For what Janus is and how the pieces fit together, see the [overview](README.md).
...
For deeper per-component detail, see each repo's own README: [agent](https://github.com/janusperf/agent), [studio](https://github.com/janusperf/studio), [desktop](https://github.com/janusperf/desktop), [cli](https://github.com/janusperf/cli).
